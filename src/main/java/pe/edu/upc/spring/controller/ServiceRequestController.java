...
public class ServiceRequestController {
	...
	public String save(@ModelAttribute ServiceRequest objServiceRequest, BindingResult binRes, Model model) throws ParseException{
		if(binRes.hasErrors())
		{
			model.addAttribute("listStatus", sService.listStatus());
			model.addAttribute("listTimes", tService.listTime());
	...
	public String listarId(Map<String, Object> model, @ModelAttribute ServiceRequest serviceRequest) throws ParseException 
	{
